...
;( function( window ) {
	...
	GridScrollFx.prototype._scrollPage = function() {
		...
		this.items.forEach( function( item ) {
			if( !item.el.classList.contains( 'shown' ) && !item.el.classList.contains( 'animate' ) && inViewport( item.el, self.options.viewportFactor ) ) {
				++self.itemsRenderedCount;
...
//Init Crap
new GridScrollFx( document.getElementById("itemList") , {
  viewportFactor : 0.4
});